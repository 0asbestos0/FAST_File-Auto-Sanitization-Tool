...
mkey='749af937f197839a0454696804dd82d16e4819ab9fe5fd63587896a887f2bf73'
...
def scan(filename,args):
	...
	try:
		...
		if args.report:
			maintool.log('info',args,'File was last analyzed on '+str(file_report.last_analysis_date)+' and the report is: ')
			#maintool.log(file_report.last_analysis_stats)
